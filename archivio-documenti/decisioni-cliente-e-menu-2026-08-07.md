...
6. **Registro attività** (⑥): intercettore automatico + buchi noti, login compreso. ~~*Prima: il confronto con Jacopo sulla collocazione nel menu.*~~
   - ✅ **CORREZIONE 31/8/2026 — quel confronto è già avvenuto: non c'è più niente da chiedere prima di cominciare.** La collocazione è stata **decisa il 24/8/2026 da Jacopo**: dentro il gruppo «Impostazioni», come **prima voce**. Motivazioni e ordine del gruppo in **§7.3 ⑥**, dove la decisione è scritta per esteso. La riga barrata resta perché l'istruzione è esistita davvero, e chi legge deve capire perché il punto 6 sembrava condizionato a un confronto. ⚠️ **Spostare la voce a menu resta però il punto 9, non questo:** qui si costruisce l'intercettore, lì si sposta la voce.
...
5. ~~📌 **Collocazione del Registro attività nel menu: confronto con Jacopo obbligatorio prima di eseguire.**~~ → ✅ **CHIUSO: il confronto è stato fatto e la collocazione decisa il 24/8/2026 da Jacopo** — dentro il gruppo «Impostazioni», come **prima voce**; motivazioni in **§7.3 ⑥**. *(Allineato il 31/8/2026: questo punto continuava a chiedere un confronto già avvenuto.)* **Non è più un punto aperto né un rischio.**
