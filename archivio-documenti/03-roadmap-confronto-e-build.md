...
- **Collaudo con le chiavi reali** OpenAI/Anthropic su Discovery e verticali. *(Le chiavi sono già configurate e il collaudo chat della V4 è superato — 22/7. Questo resta aperto solo perché è agganciato alla **Discovery consolidata su RAG** qui sopra: si collauda quando quella è pronta.)*
