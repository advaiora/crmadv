...
| **Registro attività** | L'impianto **esiste già** (tabella, filtri, pagina, permesso): manca la copertura, oggi manuale e sparsa in ~20 file, con **il login non tracciato**. Approccio deciso: **ibrido** — intercettore automatico sulle entità principali + registrazioni manuali dove serve significato ricco. ~~📌 **La collocazione nel menu si decide in un confronto con Jacopo, non da soli**~~ → ✅ **CORREZIONE 31/8/2026: il confronto è stato fatto, e la collocazione è decisa dal 24/8/2026 da Jacopo — dentro il gruppo «Impostazioni», come PRIMA voce** (motivazioni e ordine del gruppo nel piano `decisioni-cliente-e-menu-2026-08-07.md`, §7.3 ⑥). ⚠️ **Deciso non vuol dire fatto:** nel codice la voce non risulta ancora spostata *(verificato il 31/8/2026 in sola lettura: in `src/layout/Sidebar/SidebarMenu.jsx` si chiama ancora «Audit» e sta nel gruppo «Sicurezza»; il gruppo «Impostazioni» non esiste ancora)*, e spostarla è il **punto 9** dell'ordine di lavorazione (§7.5), insieme al resto del riordino menu |
...
**Punti ancora aperti:** ~~la collocazione a menu del Registro attività (confronto con Jacopo);~~ → ✅ **CORREZIONE 31/8/2026: non è più aperta.** Il confronto è avvenuto e la collocazione è stata **decisa il 24/8/2026 da Jacopo** — dentro «Impostazioni», come prima voce; vedi `decisioni-cliente-e-menu-2026-08-07.md`, §7.3 ⑥. **Resta aperto soltanto:** i due dettagli della cancellazione messaggi (traccia «messaggio eliminato» sì/no, limite di tempo sì/no).
