...
- **Cost control**: stima costo/token su ogni pulsante AI + **budget giornaliero per dipendente** con tracking consumi. *(La stima costi lato motore c'è già ed è ora estesa a Claude; l'esposizione su ogni pulsante e il **budget per dipendente** — tabella `AiBudget` + enforcement + UI — restano da fare: richiedono una nuova migrazione.)*
