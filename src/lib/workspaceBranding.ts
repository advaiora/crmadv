...
export const applyWorkspaceBranding = (workspaceBranding?: WorkspaceBrandingState | null) => {
  ...
  rootStyle.setProperty('--brand-yellow-soft', primarySoft);
  rootStyle.setProperty('--brand-yellow-hover-foreground', primaryHoverForeground);
  rootStyle.setProperty('--brand-yellow-active-foreground', primaryActiveForeground);
  rootStyle.setProperty('--brand-yellow-soft-foreground', primarySoftForeground);
