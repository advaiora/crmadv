...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('rounded-xl border border-cardBorder bg-card text-text shadow-sm transition hover:bg-hover', className)}
    {...props}
  />
));
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3 ref={ref} className={cn('text-base font-semibold leading-none tracking-tight md:text-lg', className)} {...props} />
));
