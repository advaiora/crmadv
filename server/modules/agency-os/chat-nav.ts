...
export const CHAT_NAV_AREAS: ChatNavArea[] = [
  ...
  {
    key: 'progetti-agency',
    label: 'Progetti Agency',
    route: '/agency/projects',
    description: 'Schede progetto dell\'agenzia: Discovery, Fonti indicizzate, analisi AI.',
    module: 'projects',
    permission: 'projects.view',
  },
  {
    key: 'board-progetti',
    label: 'Board progetti',
    route: '/projects',
    description: 'Board operativa dei progetti per stato di avanzamento (pipeline).',
    module: 'projects',
    permission: 'projects.view',
  },
  {
    ...
    label: 'Alert',
    route: '/agency/alerts',
    description: 'Segnalazioni e anomalie sui progetti dell\'agenzia.',
    module: 'projects',
    permission: 'dashboard.view',
  },
  {
  ...
  },
  {
    ...
    description: 'Configurazione dell\'area Agency, incluse le chiavi dei provider AI.',
    module: 'projects',
  ...
  },
  {
    ...
    description: 'Gestione degli asset web (siti, landing) dei progetti.',
    module: 'web',
    permission: 'web.view',
  },
  {
    ...
    label: 'Vault',
    route: '/apps/vault',
    description: 'Credenziali e segreti custoditi in cassaforte.',
    module: 'vault',
