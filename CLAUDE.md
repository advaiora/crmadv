...
| **Collaudo a schermo** | *non esiste* — nessuna sessione apre un browser al posto tuo | **agente Collaudatore, sempre**, prima di dichiarare finito un punto che si vede a schermo. È il mestiere **senza gemello di repository**: la prova a schermo è per definizione fuori dalla sessione, ed è esattamente ciò che finora ogni recap ha dovuto lasciare a Jacopo |
...
| **Sicurezza e permessi** | il revisore di repository vede le convenzioni | **agente Guardiano**: ogni permesso nuovo, ogni rotta nuova, e la passata a codice fermo prima di ogni release |
